<div align="center">
  <img width="1600" height="400" alt="Encore Header" src="https://github.com/user-attachments/assets/3537601a-a2c0-4f38-8ec7-48fec8fcb04f" style="border-radius: 20px; margin-bottom: 20px;" />
...
*Note: For Multiplex tracks (where vocals are on one channel and instrumentals on the other), add `.multiplexed.` to the filename before the extension (e.g., `Song.multiplexed.mp3`).*
...
*To run in full-screen Kiosk mode (which disables Windows Explorer to replicate a true arcade machine), pass the `--kiosk` flag.*
